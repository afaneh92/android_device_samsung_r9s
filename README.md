...
Supported Models
-------------
Galaxy S21 FE (Exynos): G990E.

Download & Guide
-------------
                
1. Unlock your bootloader.
2. Downloads for Galaxy S21 FE (Exynos): [r9s](https://www.androidfilehost.com/?w=files&flid=333377)
3. Reboot to download mode
4. Uncheck auto reboot in Odin and flash TWRP in AP slot and [vbmeta_disabled.tar](https://github.com/afaneh92/android_device_samsung_r9s/raw/github.io/docs/vbmeta_disabled.tar) in USERDATA slot.
...
Sources
-------------
[Kernel tree](https://github.com/afaneh92/android_kernel_samsung_r9s)

[Device tree](https://github.com/afaneh92/android_device_samsung_r9s)

Changelog
-------------
[GitHub History](https://github.com/afaneh92/android_device_samsung_r9s/commits/android-11)
